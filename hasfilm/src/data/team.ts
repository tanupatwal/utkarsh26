...
export const TEAM_MEMBERS: TeamMember[] = [
    ...
    { name: 'Mahima', role: 'Assistant General Secretary (Amphitheatre)', image: '/assets/team/ags-amphitheatre-mahima.jpg' },
    { name: 'Nikhil', role: 'Assistant General Secretary (Non-Tech)', image: '/assets/team/ags-non-tech-nikhil.jpg' },
    ...
    { name: 'Rajeshwari', role: 'Assistant General Secretary', image: '/assets/team/ags-rajeshwari.jpg' },
    { name: 'Sahitya', role: 'Assistant General Secretary (Media)', image: '/assets/team/ags-media-sahitya.jpg' },
